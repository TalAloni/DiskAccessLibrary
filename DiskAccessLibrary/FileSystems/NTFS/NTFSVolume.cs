...
namespace DiskAccessLibrary.FileSystems.NTFS
{
    ...
    public partial class NTFSVolume : IExtendableFileSystem
    {
        ...
        public virtual List<KeyValuePair<MftSegmentReference, FileNameRecord>> GetFileNameRecordsInDirectory(MftSegmentReference directoryReference)
        {
            List<KeyValuePair<MftSegmentReference, FileNameRecord>> result;
            lock (m_mftLock)
            {
                FileRecord directoryRecord = GetFileRecord(directoryReference);
                if (!directoryRecord.IsDirectory)
